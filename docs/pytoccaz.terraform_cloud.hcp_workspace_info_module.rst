.. _pytoccaz.terraform_cloud.hcp_workspace_info_module:


*******************************************
pytoccaz.terraform_cloud.hcp_workspace_info
*******************************************

**Terraform Cloud API (HCP) module to display a workspace.**
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>The data attribute from HCP route <code>GET /workspaces/:workspace_id</code> or <code>GET /organizations/:organization_name/workspaces/:name</code></div>
                    <br/>
                </td>
            </tr>
    </table>
